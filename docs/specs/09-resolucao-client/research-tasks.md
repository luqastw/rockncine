# Tarefas originais — Otimização para PCs fracos

> Conteúdo migrado verbatim de `tasks.md` em 2026-09-18, ao mover esta spec para o formato SDD.
> Registro histórico do plano de execução original (decisões A1–A5 e tarefas T1–T13, com a
> ordem de execução). O `tasks.md` novo foi reconstruído no formato SDD (T-001…) nesta mesma
> pasta; este arquivo preserva a numeração e o texto originais, sem edição.
